...
class Block {
    ...
    static genesis(){
        ...
        return new this(timestamp, lastHash, hash.replace(/(\d{0})/,'0000000'), data, nonce, difficulty, 0);
    }

    static mineBlock(lastBlock, data, controlFlag){
        let hash, timestamp;
        ...
        let t1 = Date.now();
        do{
            //Verificar si se ha encontrado un bloque valido
            if(controlFlag){
